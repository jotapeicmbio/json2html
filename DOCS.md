...
2. Configure ambiente com [CONTRIBUTING.md](CONTRIBUTING.md) → "Setup do Ambiente"
3. Siga padrões definidos em [.copilot-instructions.md](.copilot-instructions.md)
...
2. Contexto arquitetural em [ARCHITECTURE.md](ARCHITECTURE.md)
3. Exemplos de desenvolvimento em [CONTRIBUTING.md](CONTRIBUTING.md)
